#!/bin/bash
#SBATCH --output /nobackup/lab_villunger/bsilke/logs/htseq_count_Nutl_%j.log # log file location (stdout), %j stands for unique job ID
#SBATCH --job-name=htseq_count_Nutl
...
#SBATCH --error /nobackup/lab_villunger/bsilke/logs/htseq_count_Nutl_%j.err # error log file location (stderr), %j stands for unique job ID
...
# *** run the job ***
date
./htseqcount_all_features.sh "Nutl"
date
