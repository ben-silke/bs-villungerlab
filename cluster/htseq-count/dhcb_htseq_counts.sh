#!/bin/bash
#SBATCH --output /nobackup/lab_villunger/bsilke/logs/htseq_count_DHCB_%j.log # log file location (stdout), %j stands for unique job ID
#SBATCH --job-name=htseq_count_DHCB
...
#SBATCH --error /nobackup/lab_villunger/bsilke/logs/htseq_count_DHCB_%j.err # error log file location (stderr), %j stands for unique job ID
