#!/bin/bash
#SBATCH --output /nobackup/lab_villunger/bsilke/logs/star_counts_gencode_DHCB_%j.log # log file location (stdout), %j stands for unique job ID
#SBATCH --job-name=star_counts_gencode_DHCB
...
#SBATCH --error /nobackup/lab_villunger/bsilke/logs/star_counts_gencode_DHCB_%j.err # error log file location (stderr), %j stands for unique job ID
