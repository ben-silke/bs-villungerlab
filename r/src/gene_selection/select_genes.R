...
dds <- ddseq
results_data_file
if (file.exists(results_data_file)){
  ...
  results_t36_df <- return_results(dds, "timepoint_t36_vs_t0", "_36")
  results_t48_df <- return_results(dds, "timepoint_t48_vs_t0", "_48")
  save(results_t48_df, results_t16_df, results_t20_df, results_t24_df, results_t36_df, file=results_data_file)
}

df <- results_t24_df
all_df_merged_df <- merge_all_data(results_t48_df, results_t16_df, results_t20_df, results_t24_df, results_t36_df, 'results/output_encode/ZM/all_gene_regulation_data.csv', 'full_join')
df <- all_df_merged_df
df$symbol_48
df <- fix_labels(df)
df$symbol
...
upr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/upregulated_genes.pdf", plot = upr_plot, dpi=dpi, width=width_in, height=height_in)
...
downr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/downregulated_genes.pdf", plot = downr_plot, dpi=dpi, width=width_in, height=height_in)
...
write.csv(middle_points, file = "results/output_encode/ZM/middle_timepoints_signature.csv")
ggsave(filename = "results/output_encode/ZM/middle_timepoints.pdf", plot = middle_points_plot, dpi=dpi, width=width_in, height=height_in)
######
...
write.csv(full_signature_threshold, file = "results/output_encode/ZM/5n_threshold_1lfc_signature.csv")
...
write.csv(full_signature_threshold_decrease, file = "results/output_encode/ZM/full_signature_5n_decrease.csv")
noquote_full_signature_threshold_decrease_df <- noquote(full_signature_threshold_decrease$symbol)
write(noquote_full_signature_threshold_decrease_df, file = "results/output_encode/ZM/full_signature_5n_decrease.txt")
...
write.csv(full_signature_threshold_increase, file = "results/output_encode/ZM/full_signature_5n_increase.csv")
noquote_full_signature_threshold_increase_df <- noquote(full_signature_threshold_increase$symbol)
write(noquote_full_signature_threshold_increase_df, file = "results/output_encode/ZM/full_signature_5n_increase.txt")
...
ggsave(filename = "results/output_encode/ZM/5n_plot.pdf", plot = full_signature_plot, dpi=dpi, width=width_in, height=height_in)
...
write.csv(two_consecutivesubset_df, file = "results/output_encode/ZM/gene_signature_2n.csv")
...
write.csv(two_consecutivesubset_df_increase, file = "results/output_encode/ZM/gene_signature_2n_increase.csv")

noquote_two_consecutivesubset_df_increase <- noquote(two_consecutivesubset_df_increase$symbol)
write(noquote_two_consecutivesubset_df_increase, file = "results/output_encode/ZM/gene_signature_2n_increase.txt")
...
write.csv(two_consecutivesubset_df_decrease, file = "results/output_encode/ZM/gene_signature_2n_decrease.csv")
noquote_two_consecutivesubset_df_decrease <- noquote(two_consecutivesubset_df_decrease$symbol)
write(noquote_two_consecutivesubset_df_decrease, file = "results/output_encode/ZM/gene_signature_2n_decrease.txt")
...
write.csv(three_consecutivesubset_df, file = "results/output_encode/ZM/gene_signature_3n.csv")
...
write.csv(three_consecutivesubset_df_increase, file = "results/output_encode/ZM/gene_signature_3n_increase.csv")
noquote_three_consecutivesubset_df_increase <- noquote(three_consecutivesubset_df_increase$symbol)
write(noquote_three_consecutivesubset_df_increase, file = "results/output_encode/ZM/gene_signature_3n_increase.txt")
...
write.csv(three_consecutivesubset_df_decrease, file = "results/output_encode/ZM/gene_signature_3n_decrease.csv")
noquote_three_consecutivesubset_df_decrease <- noquote(three_consecutivesubset_df_decrease$symbol)
write(noquote_three_consecutivesubset_df_decrease, file = "results/output_encode/ZM/gene_signature_3n_decrease.txt")
...
ggsave(filename = "results/output_encode/ZM/plot_two_consecutive_values.pdf", plot = two_p, dpi=dpi, width=width_in, height=height_in)
...
ggsave(filename = "results/output_encode/ZM/plot_three_consecutive_values.pdf", plot = three_p, dpi=dpi, width=width_in, height=height_in)
...
upr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/three_consecutive_upregulated_genes.pdf", plot = upr_plot, dpi=dpi, width=width_in, height=height_in)
...
downr_plot <- plot_longdf(downr_top_long_df, "ZM downregulated genes: (3n) n25 | t24")
downr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/three_consecutive_downregulated_genes.pdf", plot = downr_plot, dpi=dpi, width=width_in, height=height_in)
...
upr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/full_upregulated_genes.pdf", plot = upr_plot, dpi=dpi, width=width_in, height=height_in)
...
downr_plot <- plot_longdf(downr_top_long_df, "ZM downregulated genes: (3n) n25 | t24")
downr_plot
ggsave(filename = "results/output_encode/ZM/n25generegulation/full_consecutive_downregulated_genes.pdf", plot = downr_plot, dpi=dpi, width=width_in, height=height_in)
