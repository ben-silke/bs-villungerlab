...
upr_plot
ggsave(filename = "results/output_encode/Noc/n25generegulation/Noc_upregulated_genes.pdf", plot = upr_plot, dpi=dpi, width=width_in, height=height_in)
...
middle_points_plot <- plot_longdf(middle_points_long_df, "Noc genes (20,24,36 timepoints)")
middle_points_plot

write.csv(middle_points, file = "results/output_encode/Noc/Noc_middle_timepoints_signature.csv")
ggsave(filename = "results/output_encode/Noc/Noc_middle_timepoints.pdf", plot = middle_points_plot, dpi=dpi, width=width_in, height=height_in)
######
...
write.csv(full_signature_threshold, file = "results/output_encode/Noc/Noc_5n_threshold_1lfc_signature.csv")
...
write.csv(full_signature_threshold_decrease, file = "results/output_encode/Noc/Noc_full_signature_5n_decrease.csv")
noquote_full_signature_threshold_decrease_df <- noquote(full_signature_threshold_decrease$symbol)
write(noquote_full_signature_threshold_decrease_df, file = "results/output_encode/Noc/Noc_full_signature_5n_decrease.txt")
...
write.csv(full_signature_threshold_increase, file = "results/output_encode/Noc/Noc_full_signature_5n_increase.csv")
noquote_full_signature_threshold_increase_df <- noquote(full_signature_threshold_increase$symbol)
write(noquote_full_signature_threshold_increase_df, file = "results/output_encode/Noc/Noc_full_signature_5n_increase.txt")

full_signature_threshold_long_df <- make_longdf_for_plot(full_signature_threshold, 24)
plot_title <- "Full Signature Noc treatment Signature: l4c>1"
...
plot_title <- "2 Consecutive Values Noc treatment Signature"
...
ggsave(filename = "results/output_encode/Noc/Noc_plot_two_consecutive_values.pdf", plot = two_p, dpi=dpi, width=width_in, height=height_in)


three_consecutivesubset_long_df <- make_longdf_for_plot(three_consecutivesubset_df, 24)
plot_title <- "3 Consecutive Values Noc treatment Signature"
...
ggsave(filename = "results/output_encode/Noc/Noc_plot_three_consecutive_values.pdf", plot = three_p, dpi=dpi, width=width_in, height=height_in)
...
upr_top <- head(upr_df_sorted, 25)
upr_top_long_df <- make_longdf_for_plot(upr_top, 24)
upr_plot <- plot_longdf(upr_top_long_df, "Noc upregulated genes: (3n) n25 | t24")
upr_plot
...
downr_plot <- plot_longdf(downr_top_long_df, "Noc downregulated genes: (3n) n25 | t24")
downr_plot
ggsave(filename = "results/output_encode/Noc/n25generegulation/Noc_three_consecutive_downregulated_genes.pdf", plot = downr_plot, dpi=dpi, width=width_in, height=height_in)
...
upr_plot <- plot_longdf(upr_top_long_df, "Noc upregulated genes: (5n) n25 | t24")
upr_plot
...
downr_plot <- plot_longdf(downr_top_long_df, "Noc downregulated genes: (3n) n25 | t24")
downr_plot
ggsave(filename = "results/output_encode/Noc/n25generegulation/Noc_full_consecutive_downregulated_genes.pdf", plot = downr_plot, dpi=dpi, width=width_in, height=height_in)
