...
if (file.exists(data_file)){
  ...
  save(results_Etop_t48_df, results_Etop_t8_df, results_Etop_t12_df, results_Etop_t16_df, results_Etop_t24_df, file=data_file)
}
...
ggsave(filename = "results/output_encode/Etop/Etop_5n_plot.pdf", plot = full_signature_plot, dpi=dpi, width=width_in, height=height_in)
...
write.csv(two_consecutivesubset_df, file = "results/output_encode/Etop/Etop_gene_signature_2n.csv")
...
write.csv(three_consecutivesubset_df, file = "results/output_encode/Etop/Etop_gene_signature_3n.csv")
