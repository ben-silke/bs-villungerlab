...
write.csv(fgseaRes_increase_3n_print, file = "results/output_encode/Noc/fgsea_enrichment/fgsea_enrichment_Noc_increase_3n.csv")
...
write.csv(fgseaRes_increase_2n_print, file = "results/output_encode/Noc/fgsea_enrichment/fgsea_enrichment_Noc_increase_2n.csv")
...
write.csv(significant_pathways_3n_print, file = "results/output_encode/Noc/fgsea_enrichment/significant_pathways_3n.csv")
...
saveWidget(interactive_increase_plot, "results/output_encode/Noc/fgsea_enrichment/Noc_interactive_increase_plot.html")
...
saveWidget(interactive_decrease_plot, "results/output_encode/Noc/fgsea_enrichment/Noc_interactive_decrease_plot.html")
