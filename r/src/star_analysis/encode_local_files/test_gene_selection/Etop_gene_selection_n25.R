...
upr_top_merged_df <- merge_all_data(upr_top, results_Etop_t8_df, results_Etop_t12_df, results_Etop_t24_df, results_Etop_t48_df, 'results/generegulation/Etop_gene_regulation_data.csv')
upr_top_long_df <- make_longdf_for_plot(upr_top_merged_df, 16)
upr_plot <- plot_longdf(upr_top_long_df, "Etop upregulated genes")
upr_plot
ggsave(filename = "results/generegulation/Etop_upregulated_genes.pdf", plot = upr_plot)
...
downr_plot
ggsave(filename = "results/generegulation/Etop_downregulated_genes.pdf", plot = downr_plot)
