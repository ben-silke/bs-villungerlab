...
results_Etop_t24_df <- return_results(dds, "timepoint_t24_vs_t0", "_24")
results_Etop_t16_df <- return_results(dds, "timepoint_t16_vs_t0", "_16")
results_Etop_t20_df <- return_results(dds, "timepoint_t20_vs_t0", "_20")
results_Etop_t36_df <- return_results(dds, "timepoint_t36_vs_t0", "_36")
results_Etop_t48_df <- return_results(dds, "timepoint_t48_vs_t0", "_48")

dfs <- list(results_Etop_t16_df, results_Etop_t20_df, results_Etop_t36_df, results_Etop_t48_df)
df <- results_Etop_t24_df
