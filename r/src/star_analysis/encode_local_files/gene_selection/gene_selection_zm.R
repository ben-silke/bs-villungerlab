...
results_zm_t24_df <- return_results(dds, "timepoint_t24_vs_t0", "_24")
results_zm_t16_df <- return_results(dds, "timepoint_t16_vs_t0", "_16")
results_zm_t20_df <- return_results(dds, "timepoint_t20_vs_t0", "_20")
results_zm_t36_df <- return_results(dds, "timepoint_t36_vs_t0", "_36")
results_zm_t48_df <- return_results(dds, "timepoint_t48_vs_t0", "_48")

dfs <- list(results_zm_t16_df, results_zm_t20_df, results_zm_t36_df, results_zm_t48_df)
...
downr_plot <- plot_longdf(upr_top_long_df, "ZM downregulated genes")
downr_plot
