...
write.csv(full_signature, file = "results/output_encode/Nutl/Nutl_full_signature_threshold_1lfc_signature.csv")
...
ggsave(filename = "results/output_encode/Nutl/Nutl_full_signature_plot.pdf", plot = two_p, dpi=dpi, width=width_in, height=height_in)
