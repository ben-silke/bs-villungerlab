...
upr_top_merged_df <- merge_all_data(upr_top, results_Noc_t16_df, results_Noc_t20_df, results_Noc_t36_df, results_Noc_t48_df, 'results/output_encode/Noc/n25generegulation/Noc_gene_regulation_data.csv')
...
upr_plot
ggsave(filename = "results/output_encode/Noc/n25generegulation/Noc_upregulated_genes.pdf", plot = upr_plot)

downr_df_sorted <- df[order(df$log2FoldChange), ]
# set the number of results which you want
downr_top <- head(upr_df_sorted, 25)
downr_top_merged_df <- merge_all_data(downr_top, results_Noc_t16_df, results_Noc_t20_df, results_Noc_t36_df, results_Noc_t48_df, 'results/output_encode/Noc/n25generegulation/Noc_gene_regulation_data.csv')
...
downr_plot
ggsave(filename = "results/output_encode/Noc/n25generegulation/Noc_downregulated_genes.pdf", plot = downr_plot)
...
# 
# # 'results/output_encode/Noc/all_Noc_gene_regulation_data.csv'
# write.csv(subset_df, file = "results/output_encode/Noc/Noc_all_timepoints.csv")
# subset_long_df <- make_longdf_for_plot(subset_df, 24)
# subset_plot <- plot_longdf(subset_long_df, "Noc genes (all timepoints)")
# subset_plot

# ggsave(filename = "results/output_encode/Noc/Noc_all_timepoints.pdf", plot = subset_plot)
...
write.csv(semi_subset_df, file = "results/output_encode/Noc/Noc_middle_timepoints_signature.csv")
ggsave(filename = "results/output_encode/Noc/Noc_middle_timepoints.pdf", plot = semi_subset_plot)
######
...
ggsave(filename = "results/output_encode/Noc/Noc_plot_two_consecutive_values.pdf", plot = two_p)
...
ggsave(filename = "results/output_encode/Noc/Noc_plot_three_consecutive_values.pdf", plot = three_p)
