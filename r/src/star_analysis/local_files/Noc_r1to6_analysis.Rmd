...
load(glue('r/data/', 'Noc_r1to6_star.RData'))
...
title("PCA plot highlighting batch differences for VST for Noc: r1to6")
```
...
```{r}
plotPCA(vsd_Noc, intgroup=c('batch'))
title("PCA plot highlighting batch differences for VST for Noc: r1to6")
```
...
write.csv(results_ordered_Noc_16_df, file = "../../../../results/batch_corrected_Noc_16_data.csv")
```
...
write.csv(results_ordered_Noc_20_df, file = "../../../../results/batch_corrected_Noc_20_data.csv")
```
...
write.csv(results_ordered_Noc_24_df, file = "../../../../results/batch_corrected_Noc_24_data.csv")
```
...
write.csv(results_ordered_Noc_36_df, file = "../../../../results/batch_corrected_Noc_36_data.csv")
```
...
write.csv(results_ordered_Noc_48_df, file = "../../../../results/batch_corrected_Noc_48_data.csv")
```
