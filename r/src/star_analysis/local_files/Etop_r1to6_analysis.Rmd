...
---
title: "STAR Analysis - Etop_r1to6"
...
library(dplyr)
library(openxlsx)
load('~/bs-villungerlab/r/data/Etop_r1to6_star.RData')


dds_Etop_r1to6 <- ddseq_Etop
...
plot <- plotPCA(vsd_Etop, intgroup=c('batch', 'timepoint'))
plot + ggtitle("PCA plot highlighting batch differences for VST for Etop: r1to6")
```
...
```{r}
plot <- plotPCA(vsd_Etop, intgroup=c('batch'))
plot + ggtitle("PCA plot highlighting batch differences for VST for Etop: r1to6")
```
...
```{r}
plotPCA(vsd_Etop, intgroup=c('timepoint'))
```
...
EnhancedVolcano(
    ...
    x = 'logFC',
    y = 'adj.P.Val',
    title = 'Batch controlled Etop t0_t8 (limma)',
...
# write.csv(results_ordered_Etop_8_df, file = "~/bs-villunger/results/batch_corrected_Etop_8_data.csv")
```
...
EnhancedVolcano(
    ...
    x = 'logFC',
    y = 'adj.P.Val',
    title = 'Batch controlled Etop t0_t12 (limma)',
    ylab = expression(paste('-Log'[10],' adj P')),       # Y-axis label
    # with adj p cutoff of 0.05
    pCutoff = 0.05,
    # at least double, or less than half
...
# write.csv(results_ordered_Etop_12_df, file = "~/bs-villunger/results/batch_corrected_Etop_12_data.csv")
```
...
EnhancedVolcano(
    ...
    x = 'logFC',
    y = 'adj.P.Val',
    title = 'Batch controlled Etop t0_t16 (limma)',
    ylab = expression(paste('-Log'[10],' adj P')),       # Y-axis label
    # with adj p cutoff of 0.05
    pCutoff = 0.05,
    # at least double, or less than half
...
# write.csv(results_ordered_Etop_16_df, file = "~/bs-villunger/results/batch_corrected_Etop_16_data.csv")
```
...
EnhancedVolcano(
    ...
    x = 'logFC',
    y = 'adj.P.Val',
    title = 'Batch controlled Etop t0_t24 (limma)',
    ylab = expression(paste('-Log'[10],' adj P')),       # Y-axis label
    # with adj p cutoff of 0.05
    pCutoff = 0.05,
    # at least double, or less than half
...
# write.csv(results_ordered_Etop_24_df, file = "~/bs-villunger/results/batch_corrected_Etop_24_data.csv")
```
...
EnhancedVolcano(
    ...
    x = 'logFC',
    y = 'adj.P.Val',
    title = 'Batch controlled Etop t0_t48 (limma)',
    ylab = expression(paste('-Log'[10],' adj P')),       # Y-axis label
    # with adj p cutoff of 0.05
    pCutoff = 0.05,
    # at least double, or less than half
...
# write.csv(results_ordered_Etop_48_df, file = "~/bs-villunger/results/batch_corrected_Etop_48_data.csv")
```
