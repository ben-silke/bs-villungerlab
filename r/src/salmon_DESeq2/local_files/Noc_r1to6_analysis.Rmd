...
##### General Summary
```{r}
results_t16_t0 <- results(dds_Noc_r1to6, contrast = c("timepoint", "t16", "t0"))
...
results_t16_t0_shrunk_apeglm <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t16_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t16_t0_shrunk_ashr <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t16_vs_t0", type="ashr")
...
```{r}
design_results_t0_t16 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_t0_t16 <- lmFit(mat_Noc, design_results_t0_t16)
...
##### General Summary
```{r}
results_t20_t0 <- results(dds_Noc_r1to6, contrast = c("timepoint", "t20", "t0"))
...
DESeq2::plotMA(results_t20_t0_restricted, ylim=c(-3,3))
```
...
results_t20_t0_shrunk_apeglm <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t20_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t20_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t20_t0_shrunk_ashr <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t20_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t20_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t20 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_t0_t20 <- lmFit(mat_Noc, design_results_t0_t20)
# Replace 'treatment' and 'control' with your specific time points.
...
##### General Summary
```{r}
results_t24_t0 <- results(dds_Noc_r1to6, contrast = c("timepoint", "t24", "t0"))
...
results_t24_t0_shrunk_apeglm <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t24_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t24_t0_shrunk_ashr <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t24_vs_t0", type="ashr")
...
```{r}
design_results_t0_t24 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_t0_t24 <- lmFit(mat_Noc, design_results_t0_t24)
# Replace 'treatment' and 'control' with your specific time points.
...
##### General Summary
```{r}
results_t36_t0 <- results(dds_Noc_r1to6, contrast = c("timepoint", "t36", "t0"))
...
DESeq2::plotMA(results_t36_t0_restricted, ylim=c(-3,3))
```
...
results_t36_t0_shrunk_apeglm <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t36_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t36_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t36_t0_shrunk_ashr <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t36_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t36_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t36 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_t0_t36 <- lmFit(mat_Noc, design_results_t0_t36)
# Replace 'treatment' and 'control' with your specific time points.
...
##### General Summary
```{r}
results_t48_t0 <- results(dds_Noc_r1to6, contrast = c("timepoint", "t48", "t0"))
...
results_t48_t0_shrunk_apeglm <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t48_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t48_t0_shrunk_ashr <- lfcShrink(dds_Noc_r1to6, coef="timepoint_t48_vs_t0", type="ashr")
...
```{r}
design_results_t0_t48 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_t0_t48 <- lmFit(mat_Noc, design_results_t0_t48)
# Replace 'treatment' and 'control' with your specific time points.
