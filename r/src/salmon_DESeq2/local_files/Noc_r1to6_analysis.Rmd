...
```{r}
design_results_Noc_t0_t16 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_Noc_t0_t16 <- lmFit(mat_Noc, design_results_Noc_t0_t16)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t16
contrast.matrix <- makeContrasts(timepointt16, levels=design_results_Noc_t0_t16)
fit2_results_Noc_t0_t16 <- contrasts.fit(fit_results_Noc_t0_t16, contrast.matrix)
fit2_results_Noc_t0_t16 <- eBayes(fit2_results_Noc_t0_t16)

results_Noc_Noc_results_Noc_t0_t16 <- topTable(fit2_results_Noc_t0_t16, adjust.method="BH", number=Inf)
results_Noc_results_Noc_t0_t16 <- add_annotations_to_results(results_Noc_results_Noc_t0_t16)

results_Noc_clean__results_Noc_t0_t16 <- results_Noc_results_Noc_t0_t16[!is.na(results_Noc_results_Noc_t0_t16$logFC), ]

results_Noc_ordered_results_Noc_t0_t16 <- results_Noc_clean__results_Noc_t0_t16[order(results_Noc_clean__results_Noc_t0_t16$logFC), ]
```

```{r}
selected_genes_results_Noc_t0_t16 <- as.character(results_Noc_ordered_results_Noc_t0_t16$symbol)

EnhancedVolcano(
    results_Noc_ordered_results_Noc_t0_t16,
    lab = selected_genes_results_Noc_t0_t16,
    x = 'logFC',
    y = 'adj.P.Val',
...
```{r include=FALSE}
results_Noc_ordered_results_Noc_t0_t16 <- add_annotations_to_results(results_Noc_ordered_results_Noc_t0_t16)
results_Noc_ordered_results_Noc_t0_t16_df <- as.data.frame(results_Noc_ordered_results_Noc_t0_t16)
write.csv(results_Noc_ordered_results_Noc_t0_t16_df, file = "../../../../results/batch_corrected_results_Noc_t0_t16_data.csv")
```
...
```{r}
design_results_Noc_t0_t20 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_Noc_t0_t20 <- lmFit(mat_Noc, design_results_Noc_t0_t20)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t20
contrast.matrix <- makeContrasts(timepointt20, levels=design_results_Noc_t0_t20)
fit2_results_Noc_t0_t20 <- contrasts.fit(fit_results_Noc_t0_t20, contrast.matrix)
fit2_results_Noc_t0_t20 <- eBayes(fit2_results_Noc_t0_t20)

results_Noc_Noc_results_Noc_t0_t20 <- topTable(fit2_results_Noc_t0_t20, adjust.method="BH", number=Inf)
results_Noc_results_Noc_t0_t20 <- add_annotations_to_results(results_Noc_results_Noc_t0_t20)

results_Noc_clean__results_Noc_t0_t20 <- results_Noc_results_Noc_t0_t20[!is.na(results_Noc_results_Noc_t0_t20$logFC), ]

results_Noc_ordered_results_Noc_t0_t20 <- results_Noc_clean__results_Noc_t0_t20[order(results_Noc_clean__results_Noc_t0_t20$logFC), ]
```

```{r}
selected_genes_results_Noc_t0_t20 <- as.character(results_Noc_ordered_results_Noc_t0_t20$symbol)

EnhancedVolcano(
    results_Noc_ordered_results_Noc_t0_t20,
    lab = selected_genes_results_Noc_t0_t20,
    x = 'logFC',
    y = 'adj.P.Val',
...
```{r include=FALSE}
results_Noc_ordered_results_Noc_t0_t20 <- add_annotations_to_results(results_Noc_ordered_results_Noc_t0_t20)
results_Noc_ordered_results_Noc_t0_t20_df <- as.data.frame(results_Noc_ordered_results_Noc_t0_t20)
write.csv(results_Noc_ordered_results_Noc_t0_t20_df, file = "../../../../results/batch_corrected_results_Noc_t0_t20_data.csv")
```
...
```{r}
design_results_Noc_t0_t24 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_Noc_t0_t24 <- lmFit(mat_Noc, design_results_Noc_t0_t24)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t24
contrast.matrix <- makeContrasts(timepointt24, levels=design_results_Noc_t0_t24)
fit2_results_Noc_t0_t24 <- contrasts.fit(fit_results_Noc_t0_t24, contrast.matrix)
fit2_results_Noc_t0_t24 <- eBayes(fit2_results_Noc_t0_t24)

results_Noc_Noc_results_Noc_t0_t24 <- topTable(fit2_results_Noc_t0_t24, adjust.method="BH", number=Inf)
results_Noc_results_Noc_t0_t24 <- add_annotations_to_results(results_Noc_results_Noc_t0_t24)

results_Noc_clean__results_Noc_t0_t24 <- results_Noc_results_Noc_t0_t24[!is.na(results_Noc_results_Noc_t0_t24$logFC), ]

results_Noc_ordered_results_Noc_t0_t24 <- results_Noc_clean__results_Noc_t0_t24[order(results_Noc_clean__results_Noc_t0_t24$logFC), ]
```

```{r}
selected_genes_results_Noc_t0_t24 <- as.character(results_Noc_ordered_results_Noc_t0_t24$symbol)

EnhancedVolcano(
    results_Noc_ordered_results_Noc_t0_t24,
    lab = selected_genes_results_Noc_t0_t24,
    x = 'logFC',
    y = 'adj.P.Val',
...
```{r include=FALSE}
results_Noc_ordered_results_Noc_t0_t24 <- add_annotations_to_results(results_Noc_ordered_results_Noc_t0_t24)
results_Noc_ordered_results_Noc_t0_t24_df <- as.data.frame(results_Noc_ordered_results_Noc_t0_t24)
write.csv(results_Noc_ordered_results_Noc_t0_t24_df, file = "../../../../results/batch_corrected_results_Noc_t0_t24_data.csv")
```
...
```{r}
design_results_Noc_t0_t36 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_Noc_t0_t36 <- lmFit(mat_Noc, design_results_Noc_t0_t36)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t36
contrast.matrix <- makeContrasts(timepointt36, levels=design_results_Noc_t0_t36)
fit2_results_Noc_t0_t36 <- contrasts.fit(fit_results_Noc_t0_t36, contrast.matrix)
fit2_results_Noc_t0_t36 <- eBayes(fit2_results_Noc_t0_t36)

results_Noc_Noc_results_Noc_t0_t36 <- topTable(fit2_results_Noc_t0_t36, adjust.method="BH", number=Inf)
results_Noc_results_Noc_t0_t36 <- add_annotations_to_results(results_Noc_results_Noc_t0_t36)

results_Noc_clean__results_Noc_t0_t36 <- results_Noc_results_Noc_t0_t36[!is.na(results_Noc_results_Noc_t0_t36$logFC), ]

results_Noc_ordered_results_Noc_t0_t36 <- results_Noc_clean__results_Noc_t0_t36[order(results_Noc_clean__results_Noc_t0_t36$logFC), ]
```

```{r}
selected_genes_results_Noc_t0_t36 <- as.character(results_Noc_ordered_results_Noc_t0_t36$symbol)

EnhancedVolcano(
    results_Noc_ordered_results_Noc_t0_t36,
    lab = selected_genes_results_Noc_t0_t36,
    x = 'logFC',
    y = 'adj.P.Val',
...
```{r include=FALSE}
results_Noc_ordered_results_Noc_t0_t36 <- add_annotations_to_results(results_Noc_ordered_results_Noc_t0_t36)
results_Noc_ordered_results_Noc_t0_t36_df <- as.data.frame(results_Noc_ordered_results_Noc_t0_t36)
write.csv(results_Noc_ordered_results_Noc_t0_t36_df, file = "../../../../results/batch_corrected_results_Noc_t0_t36_data.csv")
```
...
```{r}
design_results_Noc_t0_t48 <- model.matrix(~ timepoint, colData(vsd_Noc))
fit_results_Noc_t0_t48 <- lmFit(mat_Noc, design_results_Noc_t0_t48)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t48
contrast.matrix <- makeContrasts(timepointt48, levels=design_results_Noc_t0_t48)
fit2_results_Noc_t0_t48 <- contrasts.fit(fit_results_Noc_t0_t48, contrast.matrix)
fit2_results_Noc_t0_t48 <- eBayes(fit2_results_Noc_t0_t48)

results_Noc_Noc_results_Noc_t0_t48 <- topTable(fit2_results_Noc_t0_t48, adjust.method="BH", number=Inf)
results_Noc_results_Noc_t0_t48 <- add_annotations_to_results(results_Noc_results_Noc_t0_t48)

results_Noc_clean__results_Noc_t0_t48 <- results_Noc_results_Noc_t0_t48[!is.na(results_Noc_results_Noc_t0_t48$logFC), ]

results_Noc_ordered_results_Noc_t0_t48 <- results_Noc_clean__results_Noc_t0_t48[order(results_Noc_clean__results_Noc_t0_t48$logFC), ]
```

```{r}
selected_genes_results_Noc_t0_t48 <- as.character(results_Noc_ordered_results_Noc_t0_t48$symbol)

EnhancedVolcano(
    results_Noc_ordered_results_Noc_t0_t48,
    lab = selected_genes_results_Noc_t0_t48,
    x = 'logFC',
    y = 'adj.P.Val',
...
```{r include=FALSE}
results_Noc_ordered_results_Noc_t0_t48 <- add_annotations_to_results(results_Noc_ordered_results_Noc_t0_t48)
results_Noc_ordered_results_Noc_t0_t48_df <- as.data.frame(results_Noc_ordered_results_Noc_t0_t48)
write.csv(results_Noc_ordered_results_Noc_t0_t48_df, file = "../../../../results/batch_corrected_results_Noc_t0_t48_data.csv")
```
