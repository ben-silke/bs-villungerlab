...
plotMA(results_t20_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t20_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t20_t0_shrunk_ashr, ylim=c(-3,3))
```
...
plotMA(results_t36_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t36_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t36_t0_shrunk_ashr, ylim=c(-3,3))
```
