...
results_results_ZM_t0_t16 <- topTable(fit2_results_ZM_t0_t16, adjust.method="BH", number=Inf)
results_results_ZM_t0_t16 <- add_annotations_to_results(results_results_ZM_t0_t16)

results_clean__results_ZM_t0_t16 <- results_results_ZM_t0_t16[!is.na(results_results_ZM_t0_t16$logFC), ]

results_ordered_results_ZM_t0_t16 <- results_clean__results_ZM_t0_t16[order(results_clean__results_ZM_t0_t16$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_ZM_t0_t16,
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t16 <- add_annotations_to_results(results_ZM_ordered_results_ZM_t0_t16)
results_ordered_results_ZM_t0_t16_df <- as.data.frame(results_ZM_ordered_results_ZM_t0_t16)
...
results_results_ZM_t0_t20 <- topTable(fit2_results_ZM_t0_t20, adjust.method="BH", number=Inf)
results_results_ZM_t0_t20 <- add_annotations_to_results(results_results_ZM_t0_t20)

results_clean__results_ZM_t0_t20 <- results_results_ZM_t0_t20[!is.na(results_results_ZM_t0_t20$logFC), ]

results_ordered_results_ZM_t0_t20 <- results_clean__results_ZM_t0_t20[order(results_clean__results_ZM_t0_t20$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_ZM_t0_t20,
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t20 <- add_annotations_to_results(results_ZM_ordered_results_ZM_t0_t20)
results_ordered_results_ZM_t0_t20_df <- as.data.frame(results_ZM_ordered_results_ZM_t0_t20)
...
results_results_ZM_t0_t24 <- topTable(fit2_results_ZM_t0_t24, adjust.method="BH", number=Inf)
results_results_ZM_t0_t24 <- add_annotations_to_results(results_results_ZM_t0_t24)

results_clean__results_ZM_t0_t24 <- results_results_ZM_t0_t24[!is.na(results_results_ZM_t0_t24$logFC), ]

results_ordered_results_ZM_t0_t24 <- results_clean__results_ZM_t0_t24[order(results_clean__results_ZM_t0_t24$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_ZM_t0_t24,
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t24 <- add_annotations_to_results(results_ZM_ordered_results_ZM_t0_t24)
results_ordered_results_ZM_t0_t24_df <- as.data.frame(results_ZM_ordered_results_ZM_t0_t24)
...
results_results_ZM_t0_t36 <- topTable(fit2_results_ZM_t0_t36, adjust.method="BH", number=Inf)
results_results_ZM_t0_t36 <- add_annotations_to_results(results_results_ZM_t0_t36)

results_clean__results_ZM_t0_t36 <- results_results_ZM_t0_t36[!is.na(results_results_ZM_t0_t36$logFC), ]

results_ordered_results_ZM_t0_t36 <- results_clean__results_ZM_t0_t36[order(results_clean__results_ZM_t0_t36$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_ZM_t0_t36,
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t36 <- add_annotations_to_results(results_ZM_ordered_results_ZM_t0_t36)
results_ordered_results_ZM_t0_t36_df <- as.data.frame(results_ZM_ordered_results_ZM_t0_t36)
...
results_results_ZM_t0_t48 <- topTable(fit2_results_ZM_t0_t48, adjust.method="BH", number=Inf)
results_results_ZM_t0_t48 <- add_annotations_to_results(results_results_ZM_t0_t48)

results_clean__results_ZM_t0_t48 <- results_results_ZM_t0_t48[!is.na(results_results_ZM_t0_t48$logFC), ]

results_ordered_results_ZM_t0_t48 <- results_clean__results_ZM_t0_t48[order(results_clean__results_ZM_t0_t48$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_ZM_t0_t48,
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t48 <- add_annotations_to_results(results_ZM_ordered_results_ZM_t0_t48)
results_ordered_results_ZM_t0_t48_df <- as.data.frame(results_ZM_ordered_results_ZM_t0_t48)
