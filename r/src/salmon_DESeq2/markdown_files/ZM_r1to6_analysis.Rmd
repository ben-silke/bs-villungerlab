...
```{r}
vsd_ZM <- vst(dds_ZM_1:6, blind=FALSE)
...
```{r}
rld_ZM <- rlog(dds_ZM_1:6, blind=FALSE)
...
```{r}
poisd_ZM <- PoissonDistance(t(counts(dds_ZM_1:6)))
...
##### General Summary
```{r}
results_t16_t0 <- results(dds_ZM_1:6, contrast = c("timepoint", "t16", "t0"))
...
results_t16_t0_shrunk_apeglm <- lfcShrink(dds_ZM_1:6, coef="timepoint_t16_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t16_t0_shrunk_ashr <- lfcShrink(dds_ZM_1:6, coef="timepoint_t16_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t20_t0 <- results(dds_ZM_1:6, contrast = c("timepoint", "t20", "t0"))
...
results_t20_t0_shrunk_apeglm <- lfcShrink(dds_ZM_1:6, coef="timepoint_t20_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t20_t0_shrunk_ashr <- lfcShrink(dds_ZM_1:6, coef="timepoint_t20_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t24_t0 <- results(dds_ZM_1:6, contrast = c("timepoint", "t24", "t0"))
...
results_t24_t0_shrunk_apeglm <- lfcShrink(dds_ZM_1:6, coef="timepoint_t24_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t24_t0_shrunk_ashr <- lfcShrink(dds_ZM_1:6, coef="timepoint_t24_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t36_t0 <- results(dds_ZM_1:6, contrast = c("timepoint", "t36", "t0"))
...
results_t36_t0_shrunk_apeglm <- lfcShrink(dds_ZM_1:6, coef="timepoint_t36_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t36_t0_shrunk_ashr <- lfcShrink(dds_ZM_1:6, coef="timepoint_t36_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t48_t0 <- results(dds_ZM_1:6, contrast = c("timepoint", "t48", "t0"))
...
results_t48_t0_shrunk_apeglm <- lfcShrink(dds_ZM_1:6, coef="timepoint_t48_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t48_t0_shrunk_ashr <- lfcShrink(dds_ZM_1:6, coef="timepoint_t48_vs_t0", type="ashr")
