...
fit__ZM_16 <- lmFit(mat_ZM, design__ZM_16)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t16
contrast.matrix <- makeContrasts(timepointt16, levels=design__ZM_16)
fit2__ZM_16 <- contrasts.fit(fit__ZM_16, contrast.matrix)
fit2__ZM_16 <- eBayes(fit2__ZM_16)
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t16 <- add_annotations_to_results(results_ordered_results_ZM_t0_t16)
results_ordered_results_ZM_t0_t16_df <- as.data.frame(results_ordered_results_ZM_t0_t16)
write.csv(results_ordered_results_ZM_t0_t16_df, file = "../../../../results/batch_corrected_results_ZM_t0_t16_data.csv")
```
...
fit__ZM_20 <- lmFit(mat_ZM, design__ZM_20)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t20
contrast.matrix <- makeContrasts(timepointt20, levels=design__ZM_20)
fit2__ZM_20 <- contrasts.fit(fit__ZM_20, contrast.matrix)
fit2__ZM_20 <- eBayes(fit2__ZM_20)
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t20 <- add_annotations_to_results(results_ordered_results_ZM_t0_t20)
results_ordered_results_ZM_t0_t20_df <- as.data.frame(results_ordered_results_ZM_t0_t20)
write.csv(results_ordered_results_ZM_t0_t20_df, file = "../../../../results/batch_corrected_results_ZM_t0_t20_data.csv")
```
...
fit__ZM_24 <- lmFit(mat_ZM, design__ZM_24)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t24
contrast.matrix <- makeContrasts(timepointt24, levels=design__ZM_24)
fit2__ZM_24 <- contrasts.fit(fit__ZM_24, contrast.matrix)
fit2__ZM_24 <- eBayes(fit2__ZM_24)
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t24 <- add_annotations_to_results(results_ordered_results_ZM_t0_t24)
results_ordered_results_ZM_t0_t24_df <- as.data.frame(results_ordered_results_ZM_t0_t24)
write.csv(results_ordered_results_ZM_t0_t24_df, file = "../../../../results/batch_corrected_results_ZM_t0_t24_data.csv")
```
...
fit__ZM_36 <- lmFit(mat_ZM, design__ZM_36)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t36
contrast.matrix <- makeContrasts(timepointt36, levels=design__ZM_36)
fit2__ZM_36 <- contrasts.fit(fit__ZM_36, contrast.matrix)
fit2__ZM_36 <- eBayes(fit2__ZM_36)
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t36 <- add_annotations_to_results(results_ordered_results_ZM_t0_t36)
results_ordered_results_ZM_t0_t36_df <- as.data.frame(results_ordered_results_ZM_t0_t36)
write.csv(results_ordered_results_ZM_t0_t36_df, file = "../../../../results/batch_corrected_results_ZM_t0_t36_data.csv")
```
...
fit__ZM_48 <- lmFit(mat_ZM, design__ZM_48)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t48
contrast.matrix <- makeContrasts(timepointt48, levels=design__ZM_48)
fit2__ZM_48 <- contrasts.fit(fit__ZM_48, contrast.matrix)
fit2__ZM_48 <- eBayes(fit2__ZM_48)
...
```{r include=FALSE}
results_ordered_results_ZM_t0_t48 <- add_annotations_to_results(results_ordered_results_ZM_t0_t48)
results_ordered_results_ZM_t0_t48_df <- as.data.frame(results_ordered_results_ZM_t0_t48)
write.csv(results_ordered_results_ZM_t0_t48_df, file = "../../../../results/batch_corrected_results_ZM_t0_t48_data.csv")
```
