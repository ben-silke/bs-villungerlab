...
##### General Summary
```{r}
results_t8_t0 <- results(dds_Etop_r1to6, contrast = c("timepoint", "t8", "t0"))
...
DESeq2::plotMA(results_t8_t0_restricted, ylim=c(-3,3))
```
...
results_t8_t0_shrunk_apeglm <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t8_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t8_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t8_t0_shrunk_ashr <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t8_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t8_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t8 <- model.matrix(~ timepoint, colData(vsd_Etop))
fit_results_t0_t8 <- lmFit(mat_Etop, design_results_t0_t8)
...
```{r include=FALSE}
results_ordered_results_t0_t8 <- add_annotations_to_results(results_ordered_results_t0_t8)
results_ordered_results_t0_t8_df <- as.data.frame(results_ordered_results_t0_t8)
write.csv(results_ordered_results_t0_t8_df, file = "../../../../results/batch_corrected_results_t0_t8_data.csv")
```
...
##### General Summary
```{r}
results_t12_t0 <- results(dds_Etop_r1to6, contrast = c("timepoint", "t12", "t0"))
...
DESeq2::plotMA(results_t12_t0_restricted, ylim=c(-3,3))
```
...
results_t12_t0_shrunk_apeglm <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t12_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t12_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t12_t0_shrunk_ashr <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t12_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t12_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t12 <- model.matrix(~ timepoint, colData(vsd_Etop))
fit_results_t0_t12 <- lmFit(mat_Etop, design_results_t0_t12)
# Replace 'treatment' and 'control' with your specific time points.
...
```{r include=FALSE}
results_ordered_results_t0_t12 <- add_annotations_to_results(results_ordered_results_t0_t12)
results_ordered_results_t0_t12_df <- as.data.frame(results_ordered_results_t0_t12)
write.csv(results_ordered_results_t0_t12_df, file = "../../../../results/batch_corrected_results_t0_t12_data.csv")
```
...
##### General Summary
```{r}
results_t16_t0 <- results(dds_Etop_r1to6, contrast = c("timepoint", "t16", "t0"))
...
DESeq2::plotMA(results_t16_t0_restricted, ylim=c(-3,3))
```
...
results_t16_t0_shrunk_apeglm <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t16_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t16_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t16_t0_shrunk_ashr <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t16_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t16_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t16 <- model.matrix(~ timepoint, colData(vsd_Etop))
fit_results_t0_t16 <- lmFit(mat_Etop, design_results_t0_t16)
# Replace 'treatment' and 'control' with your specific time points.
...
##### General Summary
```{r}
results_t24_t0 <- results(dds_Etop_r1to6, contrast = c("timepoint", "t24", "t0"))
...
DESeq2::plotMA(results_t24_t0_restricted, ylim=c(-3,3))
```
...
results_t24_t0_shrunk_apeglm <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t24_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t24_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t24_t0_shrunk_ashr <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t24_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t24_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t24 <- model.matrix(~ timepoint, colData(vsd_Etop))
fit_results_t0_t24 <- lmFit(mat_Etop, design_results_t0_t24)
# Replace 'treatment' and 'control' with your specific time points.
...
##### General Summary
```{r}
results_t48_t0 <- results(dds_Etop_r1to6, contrast = c("timepoint", "t48", "t0"))
...
DESeq2::plotMA(results_t48_t0_restricted, ylim=c(-3,3))
```
...
results_t48_t0_shrunk_apeglm <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t48_vs_t0", type="apeglm")
...
DESeq2::plotMA(results_t48_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
#### ASHR
```{r}
results_t48_t0_shrunk_ashr <- lfcShrink(dds_Etop_r1to6, coef="timepoint_t48_vs_t0", type="ashr")
...
DESeq2::plotMA(results_t48_t0_shrunk_ashr, ylim=c(-3,3))
```
...
```{r}
design_results_t0_t48 <- model.matrix(~ timepoint, colData(vsd_Etop))
fit_results_t0_t48 <- lmFit(mat_Etop, design_results_t0_t48)
# Replace 'treatment' and 'control' with your specific time points.
