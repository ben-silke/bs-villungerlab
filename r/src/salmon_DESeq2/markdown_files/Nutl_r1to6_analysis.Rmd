...
results_results_Nutl_t0_t8 <- topTable(fit2_results_Nutl_t0_t8, adjust.method="BH", number=Inf)
results_results_Nutl_t0_t8 <- add_annotations_to_results(results_results_Nutl_t0_t8)

results_clean__results_Nutl_t0_t8 <- results_results_Nutl_t0_t8[!is.na(results_results_Nutl_t0_t8$logFC), ]

results_ordered_results_Nutl_t0_t8 <- results_clean__results_Nutl_t0_t8[order(results_clean__results_Nutl_t0_t8$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_Nutl_t0_t8,
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t8 <- add_annotations_to_results(results_Nutl_ordered_results_Nutl_t0_t8)
results_ordered_results_Nutl_t0_t8_df <- as.data.frame(results_Nutl_ordered_results_Nutl_t0_t8)
...
results_results_Nutl_t0_t12 <- topTable(fit2_results_Nutl_t0_t12, adjust.method="BH", number=Inf)
results_results_Nutl_t0_t12 <- add_annotations_to_results(results_results_Nutl_t0_t12)

results_clean__results_Nutl_t0_t12 <- results_results_Nutl_t0_t12[!is.na(results_results_Nutl_t0_t12$logFC), ]

results_ordered_results_Nutl_t0_t12 <- results_clean__results_Nutl_t0_t12[order(results_clean__results_Nutl_t0_t12$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_Nutl_t0_t12,
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t12 <- add_annotations_to_results(results_Nutl_ordered_results_Nutl_t0_t12)
results_ordered_results_Nutl_t0_t12_df <- as.data.frame(results_Nutl_ordered_results_Nutl_t0_t12)
...
results_results_Nutl_t0_t16 <- topTable(fit2_results_Nutl_t0_t16, adjust.method="BH", number=Inf)
results_results_Nutl_t0_t16 <- add_annotations_to_results(results_results_Nutl_t0_t16)

results_clean__results_Nutl_t0_t16 <- results_results_Nutl_t0_t16[!is.na(results_results_Nutl_t0_t16$logFC), ]

results_ordered_results_Nutl_t0_t16 <- results_clean__results_Nutl_t0_t16[order(results_clean__results_Nutl_t0_t16$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_Nutl_t0_t16,
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t16 <- add_annotations_to_results(results_Nutl_ordered_results_Nutl_t0_t16)
results_ordered_results_Nutl_t0_t16_df <- as.data.frame(results_Nutl_ordered_results_Nutl_t0_t16)
...
results_results_Nutl_t0_t24 <- topTable(fit2_results_Nutl_t0_t24, adjust.method="BH", number=Inf)
results_results_Nutl_t0_t24 <- add_annotations_to_results(results_results_Nutl_t0_t24)

results_clean__results_Nutl_t0_t24 <- results_results_Nutl_t0_t24[!is.na(results_results_Nutl_t0_t24$logFC), ]

results_ordered_results_Nutl_t0_t24 <- results_clean__results_Nutl_t0_t24[order(results_clean__results_Nutl_t0_t24$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_Nutl_t0_t24,
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t24 <- add_annotations_to_results(results_Nutl_ordered_results_Nutl_t0_t24)
results_ordered_results_Nutl_t0_t24_df <- as.data.frame(results_Nutl_ordered_results_Nutl_t0_t24)
...
results_results_Nutl_t0_t48 <- topTable(fit2_results_Nutl_t0_t48, adjust.method="BH", number=Inf)
results_results_Nutl_t0_t48 <- add_annotations_to_results(results_results_Nutl_t0_t48)

results_clean__results_Nutl_t0_t48 <- results_results_Nutl_t0_t48[!is.na(results_results_Nutl_t0_t48$logFC), ]

results_ordered_results_Nutl_t0_t48 <- results_clean__results_Nutl_t0_t48[order(results_clean__results_Nutl_t0_t48$logFC), ]
```
...
EnhancedVolcano(
    results_ordered_results_Nutl_t0_t48,
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t48 <- add_annotations_to_results(results_Nutl_ordered_results_Nutl_t0_t48)
results_ordered_results_Nutl_t0_t48_df <- as.data.frame(results_Nutl_ordered_results_Nutl_t0_t48)
