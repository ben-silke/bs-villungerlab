...
```{r}
vsd_Nutl <- vst(dds_Nutl_1:6, blind=FALSE)
...
```{r}
rld_Nutl <- rlog(dds_Nutl_1:6, blind=FALSE)
...
```{r}
poisd_Nutl <- PoissonDistance(t(counts(dds_Nutl_1:6)))
...
##### General Summary
```{r}
results_t8_t0 <- results(dds_Nutl_1:6, contrast = c("timepoint", "t8", "t0"))
...
results_t8_t0_shrunk_apeglm <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t8_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t8_t0_shrunk_ashr <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t8_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t12_t0 <- results(dds_Nutl_1:6, contrast = c("timepoint", "t12", "t0"))
...
results_t12_t0_shrunk_apeglm <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t12_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t12_t0_shrunk_ashr <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t12_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t16_t0 <- results(dds_Nutl_1:6, contrast = c("timepoint", "t16", "t0"))
...
results_t16_t0_shrunk_apeglm <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t16_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t16_t0_shrunk_ashr <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t16_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t24_t0 <- results(dds_Nutl_1:6, contrast = c("timepoint", "t24", "t0"))
...
results_t24_t0_shrunk_apeglm <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t24_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t24_t0_shrunk_ashr <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t24_vs_t0", type="ashr")
...
##### General Summary
```{r}
results_t48_t0 <- results(dds_Nutl_1:6, contrast = c("timepoint", "t48", "t0"))
...
results_t48_t0_shrunk_apeglm <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t48_vs_t0", type="apeglm")
...
#### ASHR
```{r}
results_t48_t0_shrunk_ashr <- lfcShrink(dds_Nutl_1:6, coef="timepoint_t48_vs_t0", type="ashr")
