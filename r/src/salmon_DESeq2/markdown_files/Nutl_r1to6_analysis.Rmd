...
fit__Nutl_8 <- lmFit(mat_Nutl, design__Nutl_8)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t8
contrast.matrix <- makeContrasts(timepointt8, levels=design__Nutl_8)
fit2__Nutl_8 <- contrasts.fit(fit__Nutl_8, contrast.matrix)
fit2__Nutl_8 <- eBayes(fit2__Nutl_8)
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t8 <- add_annotations_to_results(results_ordered_results_Nutl_t0_t8)
results_ordered_results_Nutl_t0_t8_df <- as.data.frame(results_ordered_results_Nutl_t0_t8)
write.csv(results_ordered_results_Nutl_t0_t8_df, file = "../../../../results/batch_corrected_results_Nutl_t0_t8_data.csv")
```
...
fit__Nutl_12 <- lmFit(mat_Nutl, design__Nutl_12)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t12
contrast.matrix <- makeContrasts(timepointt12, levels=design__Nutl_12)
fit2__Nutl_12 <- contrasts.fit(fit__Nutl_12, contrast.matrix)
fit2__Nutl_12 <- eBayes(fit2__Nutl_12)
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t12 <- add_annotations_to_results(results_ordered_results_Nutl_t0_t12)
results_ordered_results_Nutl_t0_t12_df <- as.data.frame(results_ordered_results_Nutl_t0_t12)
write.csv(results_ordered_results_Nutl_t0_t12_df, file = "../../../../results/batch_corrected_results_Nutl_t0_t12_data.csv")
```
...
fit__Nutl_16 <- lmFit(mat_Nutl, design__Nutl_16)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t16
contrast.matrix <- makeContrasts(timepointt16, levels=design__Nutl_16)
fit2__Nutl_16 <- contrasts.fit(fit__Nutl_16, contrast.matrix)
fit2__Nutl_16 <- eBayes(fit2__Nutl_16)
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t16 <- add_annotations_to_results(results_ordered_results_Nutl_t0_t16)
results_ordered_results_Nutl_t0_t16_df <- as.data.frame(results_ordered_results_Nutl_t0_t16)
write.csv(results_ordered_results_Nutl_t0_t16_df, file = "../../../../results/batch_corrected_results_Nutl_t0_t16_data.csv")
```
...
fit__Nutl_24 <- lmFit(mat_Nutl, design__Nutl_24)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t24
contrast.matrix <- makeContrasts(timepointt24, levels=design__Nutl_24)
fit2__Nutl_24 <- contrasts.fit(fit__Nutl_24, contrast.matrix)
fit2__Nutl_24 <- eBayes(fit2__Nutl_24)
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t24 <- add_annotations_to_results(results_ordered_results_Nutl_t0_t24)
results_ordered_results_Nutl_t0_t24_df <- as.data.frame(results_ordered_results_Nutl_t0_t24)
write.csv(results_ordered_results_Nutl_t0_t24_df, file = "../../../../results/batch_corrected_results_Nutl_t0_t24_data.csv")
```
...
fit__Nutl_48 <- lmFit(mat_Nutl, design__Nutl_48)
# Replace 'treatment' and 'control' with your specific time points.
# Demonstrates difference between t0 and t48
contrast.matrix <- makeContrasts(timepointt48, levels=design__Nutl_48)
fit2__Nutl_48 <- contrasts.fit(fit__Nutl_48, contrast.matrix)
fit2__Nutl_48 <- eBayes(fit2__Nutl_48)
...
```{r include=FALSE}
results_ordered_results_Nutl_t0_t48 <- add_annotations_to_results(results_ordered_results_Nutl_t0_t48)
results_ordered_results_Nutl_t0_t48_df <- as.data.frame(results_ordered_results_Nutl_t0_t48)
write.csv(results_ordered_results_Nutl_t0_t48_df, file = "../../../../results/batch_corrected_results_Nutl_t0_t48_data.csv")
```
