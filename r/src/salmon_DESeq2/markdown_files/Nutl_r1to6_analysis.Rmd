...
plotMA(results_t8_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t8_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t8_t0_shrunk_ashr, ylim=c(-3,3))
```
...
plotMA(results_t12_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t12_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t12_t0_shrunk_ashr, ylim=c(-3,3))
```
...
plotMA(results_t16_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t16_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t16_t0_shrunk_ashr, ylim=c(-3,3))
```
...
plotMA(results_t24_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t24_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t24_t0_shrunk_ashr, ylim=c(-3,3))
```
...
plotMA(results_t48_t0_restricted, ylim=c(-3,3))
```
...
plotMA(results_t48_t0_shrunk_apeglm, ylim=c(-3,3))
```
...
plotMA(results_t48_t0_shrunk_ashr, ylim=c(-3,3))
```
